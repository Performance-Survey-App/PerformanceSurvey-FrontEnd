...
//     if ( password === 'adminpass' && email === 'admin@jubileelifeng.com') {
//       navigate('/admin');
//     } else if ( password === 'userpass' && email === 'user@jubileelifeng.com') {
//       navigate('/user');
//     } else {
...
const LoginPage = () => {
  ...
  try {
    const response = await fetch("https://performancesurvey.onrender.com/api/PerformanceSurvey/Adminlogin", {
      method: 'POST',
      headers: {
